                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php $sql = "SELECT tblbooks.BookName,tblbooks.CategoryName,tblbooks.AuthorName,tblbooks.ISBNNumber,tblbooks.BookPrice,tblbooks.Amount,tblbooks.Available,tblbooks.id as bookid from  tblbooks";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
