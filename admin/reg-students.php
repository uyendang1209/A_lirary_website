...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <?php } ?>
                                            <a href="reg-students.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this student?');"><button class="btn btn-primary"> Delete</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
